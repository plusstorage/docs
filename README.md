...
[plusstorage](https://www.plusserver.com/en/produkte/storage) is an open-source cloud service by [plusserver GmbH](https://plusserver.com). The technical documentation is published [here](https://docs.pco.get-cloud.io).
...
```bash
git clone https://github.com/plusstorage/docs.git
```
